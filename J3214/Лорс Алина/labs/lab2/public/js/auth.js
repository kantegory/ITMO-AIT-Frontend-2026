(() => {
  ...
  function updatePasswordStrength() {
    ...
    const config = {
      0: ['0%', '#c77da5', 'Сила пароля: не определена'],
      1: ['20%', '#c77da5', 'Сила пароля: слабый'],
      2: ['40%', '#d9a27f', 'Сила пароля: ниже среднего'],
      3: ['60%', '#cf9bc2', 'Сила пароля: средний'],
      4: ['80%', '#b985c9', 'Сила пароля: хороший'],
      5: ['100%', '#6ce41b', 'Сила пароля: сильный мега ультра']
    };
