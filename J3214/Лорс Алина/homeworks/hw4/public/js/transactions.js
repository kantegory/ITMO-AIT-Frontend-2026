(() => {
  ...
  function toggleView() {
    ...
    const icon = document.querySelector('#toggleViewBtn .sprite-icon use');
    if (icon) icon.setAttribute('href', `assets/icons.svg#icon-${state.view === 'table' ? 'grid-3x3-gap' : 'table'}`);
