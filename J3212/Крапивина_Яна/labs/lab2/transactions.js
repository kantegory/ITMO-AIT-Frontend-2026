...
function renderTable(data) {
    ...
    data.forEach(t => {
        ...
        row.innerHTML = `
            ...
            <td class="p-3" style="color: ${t.amount < 0 ? '#ff6b6b' : '#20c997'}">${t.amount.toLocaleString()} ₽</td>
        `;
        ...
        row.addEventListener('click', () => {
            ...
            document.querySelector('#transModal .modal-body').innerHTML = `
                ...
                <p><strong>Сумма:</strong> <span style="color: ${t.amount < 0 ? '#ff6b6b' : '#20c997'}">${t.amount.toLocaleString()} ₽</span></p>
            `;
