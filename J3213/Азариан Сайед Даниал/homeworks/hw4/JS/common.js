...
function getThemeToggleIconId(theme) {
...
function updateThemeToggleButton(button, theme) {
  ...
  const iconId = getThemeToggleIconId(theme);
  button.innerHTML = `<svg class="theme-toggle-icon" aria-hidden="true"><use href="assets/icons-sprite.svg#${iconId}"></use></svg><span class="visually-hidden">${
