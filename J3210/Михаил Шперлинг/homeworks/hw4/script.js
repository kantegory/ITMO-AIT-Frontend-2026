document.addEventListener("DOMContentLoaded", function() {
    ...
    if (savedTheme === 'dark' || (!savedTheme && systemPrefersDark)) {
        ...
        if (themeIconUse) themeIconUse.setAttribute('href', 'sprite.svg#icon-sun');
    }
    ...
    if (themeToggleBtn) {
        themeToggleBtn.addEventListener('click', () => {
            ...
            if (currentTheme === 'dark') {
                ...
                if (themeIconUse) themeIconUse.setAttribute('href', 'sprite.svg#icon-moon');
            } else {
                htmlElement.setAttribute('data-theme', 'dark');
    ...
    if (currentUser && navAuth) {
        navAuth.innerHTML = `
            ...
            <a href="profile.html" class="btn btn-secondary me-2" aria-label="Личный кабинет"><svg class="svg-icon" aria-hidden="true"><use href="sprite.svg#icon-person"></use></svg></a>
            ...
            fetch(`${API_URL}/${itemType}/${itemId}`)
                ...
                .then(data => {
                    ...
                    document.getElementById('starBtn').addEventListener('click', async function() {
                        ...
                        useTag.setAttribute('href', 'sprite.svg#icon-star-fill');
                        svgTag.classList.add('text-warning');
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <small class="text-muted" aria-label="Оценка: ${item.stars || 0} звезд, Скачиваний: ${item.downloads || 0}">
                                    <svg class="svg-icon text-warning" aria-hidden="true"><use href="sprite.svg#icon-star-fill"></use></svg> ${item.stars || 0} • 
                                    <svg class="svg-icon" aria-hidden="true"><use href="sprite.svg#icon-download"></use></svg> ${item.downloads || 0}
                                </small>
