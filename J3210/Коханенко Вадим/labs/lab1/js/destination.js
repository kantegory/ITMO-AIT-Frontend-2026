            ...
            <div class="row mb-4">
                <div class="col-12 d-flex justify-content-end">
                    <button class="btn btn-success me-2" onclick="openAddRouteModal('${dest.id}', '${dest.name.replace(/'/g, "\\'")}', '${dest.attractions[0]?.name || ''}, ${dest.attractions[1]?.name || ''}', '${dest.description.replace(/'/g, "\\'")}', '${dest.duration}', '${dest.budget}', '${dest.type}')"
                        ...
                        <svg class="icon" aria-hidden="true"><use xlink:href="sprite.svg#icon-map"></use></svg> Добавить в маршруты
                    </button>
                </div>
            </div>
            ...
            <div class="row g-4 mb-5">
                <div class="col-lg-8">
                    <section class="card info-card mb-4" aria-labelledby="aboutHeading">
                        <div class="card-header">
                            <h2 id="aboutHeading" class="h5 mb-0"><svg class="icon" aria-hidden="true"><use xlink:href="sprite.svg#icon-info-circle"></use></svg> О направлении</h2>
                        </div>
                        <div class="card-body">
                    ...
                    <section class="card info-card mb-4" aria-labelledby="attractionsHeading">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h2 id="attractionsHeading" class="h5 mb-0"><svg class="icon" aria-hidden="true"><use xlink:href="sprite.svg#icon-camera"></use></svg> Достопримечательности</h2>
                ...
                <div class="col-lg-4">
                    <aside class="card info-card mb-4" aria-labelledby="quickInfoHeading">
                        <div class="card-header">
                            <h2 id="quickInfoHeading" class="h5 mb-0"><svg class="icon" aria-hidden="true"><use xlink:href="sprite.svg#icon-clock"></use></svg> Быстрая информация</h2>
                        </div>
                        <div class="card-body">
                            <div class="quick-info-item text-center">
                                <div class="quick-info-icon" aria-hidden="true">
                                    <svg class="icon" aria-hidden="true"><use xlink:href="sprite.svg#icon-wallet"></use></svg>
                                </div>
                            ...
                            <div class="row g-3">
                                <div class="col-6">
                                    <div class="quick-info-icon small" aria-hidden="true">
                                        <svg class="icon" aria-hidden="true"><use xlink:href="sprite.svg#icon-calendar"></use></svg>
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="quick-info-icon small" aria-hidden="true">
                                        <svg class="icon" aria-hidden="true"><use xlink:href="sprite.svg#icon-person"></use></svg>
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="quick-info-icon small" aria-hidden="true">
                                        <svg class="icon" aria-hidden="true"><use xlink:href="sprite.svg#icon-clock"></use></svg>
                                    </div>
