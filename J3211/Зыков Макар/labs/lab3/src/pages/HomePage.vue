  ...
  <div class="container">
    <section class="hero p-4 p-lg-5 mb-4 mb-lg-5" aria-labelledby="homeHeroTitle">
      <div class="row align-items-center g-4">
        <div class="col-lg-7">
          <span class="quick-chip bg-light text-primary">Лабораторная работа 3</span>
          <h1 id="homeHeroTitle" class="display-6 fw-bold mt-3">Vue SPA на основе предыдущих лабораторных</h1>
          <p class="lead mb-4">
          ...
          <div class="hero-status-grid">
            ...
            <p class="status-value status-value-sm">Vue + Router + Axios</p>
            </article>
          </div>
