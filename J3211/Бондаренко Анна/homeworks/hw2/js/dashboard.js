...
window.initExchangeRates = async function () {
    try {
        ...
        const genCard = function (code, colClass) {
            ...
            return `
            <div class="${colClass}">
                <div class="dashboard-block mb-0" style="padding: 0; box-shadow: none; border: 2px solid #000; overflow: hidden;">
                    <div class="block-title" style="margin: 0; padding: 5px 10px; font-size: 15px; background: #000; color: #fff;">
                       ${currency.Name.toUpperCase()}
                    </div>
                    <div class="text-center" style="padding: 15px; font-size: 18px; font-weight: 700; color: #000;">
