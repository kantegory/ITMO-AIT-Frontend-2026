        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="d-flex flex-wrap gap-3 mb-3">
                    <span class="text-muted"><i class="bi bi-star-fill text-warning"></i> <strong>${course.rating}</strong> (${course.reviews} оценок)</span>
                    <span class="text-muted"><i class="bi bi-people"></i> ${course.students} студентов</span>
                ...
                <ul class="nav nav-tabs mt-4" id="courseTabs" role="tablist">
                    <li class="nav-item"><button class="nav-link active" data-bs-toggle="tab" data-bs-target="#whatYouLearn">Чему вы научитесь</button></li>
                    <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#program">Программа</button></li>
                ...
                <div class="tab-content p-4 border border-top-0 bg-white">
                    <div class="tab-pane fade show active" id="whatYouLearn">
                        <ul class="list-unstyled">
                            ${course.whatYouLearn.map(item => `<li class="py-2"><i class="bi bi-check-circle-fill text-success me-2"></i>${item}</li>`).join('')}
                        </ul>
                    </div>
                    <div class="tab-pane fade" id="program">
                        <div class="accordion" id="courseProgram">
                            <div class="accordion-item">
                                <h2 class="accordion-header"><button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#lesson1">Раздел 1: Введение</button></h2>
                                <div id="lesson1" class="accordion-collapse collapse show" data-bs-parent="#courseProgram">
                                    <div class="accordion-body">
                                        <ul class="list-unstyled mb-0">
                                            <li class="py-2"><i class="bi bi-play-circle text-danger me-2"></i>Видео: Введение в курс (15 мин)</li>
                                            <li class="py-2"><i class="bi bi-file-text text-danger me-2"></i>Статья: Основные понятия</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#lesson2">Раздел 2: Основы</button></h2>
                                <div id="lesson2" class="accordion-collapse collapse" data-bs-parent="#courseProgram">
                                    <div class="accordion-body">
                                        <ul class="list-unstyled mb-0">
                                            <li class="py-2"><i class="bi bi-play-circle text-danger me-2"></i>Видео: Базовые концепции (30 мин)</li>
                                            <li class="py-2"><i class="bi bi-file-text text-danger me-2"></i>Практическое задание</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <form id="reviewForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="reviewComment" rows="3" placeholder="Расскажите о вашем опыте..." required></textarea>
                                </div>
                                <button type="submit" class="btn btn-danger"><i class="bi bi-send"></i> Отправить отзыв</button>
                            </form>
                        </div>
                        <hr>
                        <h5 class="mb-3">Отзывы студентов</h5>
                        <div id="reviewsList">
                            <div class="text-center py-3">
                                <div class="spinner-border text-danger" role="status"><span class="visually-hidden">Загрузка...</span></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="card sticky-top" style="top: 20px; z-index: 1;">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-danger w-100 mb-2 btn-lg"><i class="bi bi-cart"></i> Купить курс</button>
                        <button id="favoriteBtn" class="btn btn-outline-danger w-100 mb-3"><i class="bi bi-heart"></i> В избранное</button>
                        <hr>
                        <h6 class="mb-3">Включено в курс:</h6>
                        <ul class="list-unstyled">
                            <li class="mb-2"><i class="bi bi-camera-video text-danger me-2"></i>${course.duration} видео</li>
                            <li class="mb-2"><i class="bi bi-file-earmark text-danger me-2"></i>${course.lessons} материалов</li>
                            <li class="mb-2"><i class="bi bi-infinity text-danger me-2"></i>Доступ навсегда</li>
                            <li class="mb-2"><i class="bi bi-patch-check text-danger me-2"></i>Сертификат</li>
                            <li class="mb-2"><i class="bi bi-phone text-danger me-2"></i>Доступ с телефона</li>
                        </ul>
                    </div>
                </div>
            </div>
